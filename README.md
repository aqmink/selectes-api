...
### Запуск
 ...
 ### Отладка работы приложения
   ...
   1) Приложение запустилось с ошибкой парсера
      ...
      > app/service/parser.py строчка 43

   3) Заметил что вакансии парсяться слишком часто:
   ...
   4) В логах возникает предупреждение от планировщика о пропуске задач парсинга
