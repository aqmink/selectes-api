...
async def upsert_external_vacancies(
    ...
    for payload in payloads:
        ...
        #     for field, value in payload.items():  | После парсинга изменялись существующие вакансии,
        #         setattr(vacancy, field, value)    | которые могли быть до этого намеренно изменены
        # else:
