                ...
                parsed_payloads.append(
                    {
                        ...
                        ### Начало фикса ###                               # Отсутствует обработка поля
                        "city_name":                                       # ExternalVacancyItem.city 
                            item.city.name.strip() if item.city else None, # может принимать значение
                        ### Конец фикса ###                                # NoneType
